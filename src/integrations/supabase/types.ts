  ...
  public: {
    Tables: {
      ...
      event_backups: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_backups_event_id_fkey";
            columns: ["event_id"];
            isOneToOne: false;
            referencedRelation: "events";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      get_registration_email_info_by_registration_id: {
        Args: { p_registration_id: string; p_secret: string };
        Returns: {
          city: string;
          company: string;
          country: string;
