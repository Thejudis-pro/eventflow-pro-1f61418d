...
const PARTNERS = ["Banque mondiale", "CEDEAO", "UEMOA", "PNUD", "GIZ", "FAO", "BAD", "ONU Femmes"];
...
function Landing() {
  ...
  const objectifsReveal = useReveal<HTMLDivElement>();
    ...
    <div className="min-h-screen bg-[#f8f4eb] text-[#183b24]">
      ...
      <main>
            ...
            <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
              <div className="max-w-3xl">
                ...
                <p className="mt-6 max-w-2xl text-lg text-white/80 sm:text-xl">
                  Entrepreneuriat, économie sociale et solidaire et souveraineté alimentaire en
                  Afrique de l'Ouest.
                </p>
                <div className="mt-8 flex flex-wrap gap-3">
                  ...
                  <Button
                    asChild
                    size="xl"
                    className="border border-white/20 bg-white/10 text-[#fdf8ef] hover:bg-white/20"
                  >
                    ...
                    <div className="mt-6 rounded-[1.25rem] border border-[#0d3d21]/10 bg-white p-5 shadow-sm">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-[#3d5a45]">
        ...
        <section className="border-b border-[#dcd2bd] bg-[#fbf5eb]">
          <div className="mx-auto grid max-w-7xl gap-6 px-4 py-10 sm:grid-cols-2 lg:grid-cols-4 lg:px-8">
            {STATS.map((item) => (
              <div
                key={item.label}
                className="rounded-2xl border border-[#e3dccf] bg-white/70 p-5 shadow-sm"
              >
                <p className="font-display text-4xl font-black text-[#0d3d21]">{item.value}</p>
                <p className="mt-1 text-sm uppercase tracking-[0.2em] text-[#5f6f5f]">
                  {item.label}
                </p>
              </div>
            ))}
        ...
        <section id="forum" className="mx-auto max-w-7xl px-4 py-20 lg:px-8">
          <div
            ref={forumReveal.ref}
            className={`grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-start ${forumReveal.className}`}
          >
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#e8722a]">
                Le forum
              </p>
              <h2 className="mt-3 text-3xl font-black sm:text-4xl">
                Formaliser, financer, transformer.
              </h2>
              <p className="mt-5 max-w-xl text-lg text-[#4f5f51]">
                La 1ʳᵉ édition du FESA rassemble les entreprises, coopératives, institutions et
                partenaires autour d'un agenda commun dédié à la souveraineté alimentaire et à la
                transition économique en Afrique de l'Ouest.
              </p>
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
              {GOALS.map((goal) => (
                <article
                  key={goal.title}
                  className="rounded-2xl border border-[#e3dccf] bg-white p-6 shadow-sm"
                >
        ...
        <section id="objectifs" className="bg-white py-20">
          <div
            ...
            className={`mx-auto max-w-7xl px-4 lg:px-8 ${objectifsReveal.className}`}
          >
            <div className="grid gap-10 lg:grid-cols-[0.78fr_1.22fr]">
              <div className="rounded-[2rem] border border-[#e3dccf] bg-[#f8f4eb] p-8">
                ...
                <h2 className="mt-3 text-3xl font-black text-[#0d3d21]">
                  Un agenda régional pluriannuel
                </h2>
                <p className="mt-4 text-lg text-[#4f5f51]">
                  Le FESA pose les bases d'une dynamique durable entre femmes entrepreneures,
                  coopératives, institutions régionales et financeurs.
                </p>
                <div className="mt-8 space-y-4">
                  {[
                    ...
                    <div
                      key={item}
                      className="flex items-start gap-3 rounded-xl border border-[#e3dccf] bg-white px-4 py-3"
                    >
              ...
              <div>
                <div className="rounded-[2rem] border border-[#e3dccf] bg-[#0d3d21] p-8 text-[#fdf8ef]">
                  <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#ffd8b5]">
                    13 axes
                  </p>
                  <div className="mt-6 flex flex-wrap gap-3">
                    {THEMES.map((theme) => (
                      <span
                        key={theme}
                        className="rounded-full border border-white/15 bg-white/10 px-3 py-2 text-sm font-medium"
                      >
                        {theme}
                      </span>
                    ))}
                ...
                <div className="mt-6 grid gap-4 sm:grid-cols-3">
                  <div className="rounded-2xl border border-[#e3dccf] bg-white p-6 shadow-sm">
                    ...
                    <p className="mt-2 text-sm text-[#5f6f5f]">
                      femmes rurales structurées en coopératives
                    </p>
                  </div>
                  <div className="rounded-2xl border border-[#e3dccf] bg-white p-6 shadow-sm">
                    <p className="font-display text-3xl font-black text-[#0d3d21]">7</p>
                    <p className="mt-2 text-sm text-[#5f6f5f]">
                      pays d'intervention en Afrique de l'Ouest
                    </p>
                  </div>
                  <div className="rounded-2xl border border-[#e3dccf] bg-white p-6 shadow-sm">
            ...
            <div className="rounded-[2rem] border border-[#e3dccf] bg-white p-8 shadow-sm">
              <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                <div className="max-w-2xl">
                  ...
                  <h2 className="mt-3 text-3xl font-black text-[#0d3d21]">
                    Les 15 pays de la CEDEAO et leurs partenaires
                  </h2>
                  <p className="mt-4 text-lg text-[#4f5f51]">
                    Le forum ouvre un espace d'échange à destination des délégations, institutions,
                    entreprises et organisations de la sous-région.
                  </p>
                </div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                {COUNTRIES.map((country) => (
                  <span
                    key={country}
                    className="rounded-full border border-[#e3dccf] bg-[#fbf5eb] px-3 py-2 text-sm text-[#27482f]"
                  >
                    {country}
                  </span>
                ))}
        ...
        <section id="programme" className="bg-white py-20">
          <div
            ...
            className={`mx-auto max-w-7xl px-4 lg:px-8 ${programmeReveal.className}`}
          >
            <div className="max-w-3xl">
              <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#e8722a]">
                Programme
            ...
            <div className="mt-10 grid gap-6 lg:grid-cols-2">
              {PROGRAM.map((day) => (
                <div
                  key={day.day}
                  className="rounded-[2rem] border border-[#e3dccf] bg-[#f8f4eb] p-8 shadow-sm"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-semibold text-[#0d3d21]">
                        {day.day === "21" ? "Lundi · septembre" : "Mardi · septembre"}
                      </p>
                    </div>
                  </div>
                  <ul className="mt-6 space-y-3">
                    {day.items.map((item) => (
                      <li
                        key={item}
                        className="flex gap-3 rounded-xl border border-[#e3dccf] bg-white px-4 py-3 text-sm text-[#4f5f51]"
                      >
        ...
        <section id="tarifs" className="bg-[#f8f4eb] py-20">
          <div
            ref={tarifsReveal.ref}
            className={`mx-auto max-w-7xl px-4 lg:px-8 ${tarifsReveal.className}`}
          >
            <div className="max-w-3xl">
              <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#e8722a]">
                Tarifs & stands
              ...
              <h2 className="mt-3 text-3xl font-black text-[#0d3d21]">
                Inscription en trois minutes depuis un téléphone
              </h2>
              <p className="mt-4 text-lg text-[#4f5f51]">
                Plusieurs formules sont disponibles selon votre profil, votre délégation et votre
                niveau d'exposition.
              </p>
            </div>
            <div className="mt-10 grid gap-6 lg:grid-cols-2">
              {TICKETS.map((ticket) => (
                <article
                  key={ticket.title}
                  className={`rounded-[2rem] border border-[#e3dccf] p-8 shadow-sm ${ticket.accent}`}
                >
                  <div className="flex items-start justify-between gap-4">
                    <div>
                  ...
                  <Button
                    asChild
                    variant={ticket.title.includes("Stand") ? "institutional" : "hero"}
                    className="mt-8"
                  >
              ...
              <div className="grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-center">
                <div>
                  ...
                  <p className="mt-4 max-w-2xl text-lg text-white/80">
                    Visibilité, mise en réseau et accès à un écosystème sous-régional de
                    coopératives, PME et décideurs.
                  </p>
                </div>
                <div className="rounded-[1.5rem] border border-white/15 bg-white/10 p-6">
                  <div className="flex flex-wrap gap-3">
                    {PARTNERS.map((partner) => (
                      <span
                        key={partner}
                        className="rounded-full border border-white/15 bg-white/10 px-3 py-2 text-sm font-medium text-[#fdf8ef]"
                      >
                        {partner}
                      </span>
                    ))}
                  ...
                  <a
                    ...
                    className="mt-6 flex h-11 items-center justify-center rounded-full bg-[#e8722a] px-5 text-sm font-semibold text-white transition hover:bg-[#c85c18]"
                  >
                    Contactez-nous
                  </a>
                </div>
            ...
            <div className="rounded-[2rem] border border-[#e3dccf] bg-white p-8 shadow-sm">
              <div className="grid gap-6 lg:grid-cols-[1fr_0.8fr] lg:items-center">
                <div>
                  ...
                  <h2 className="mt-3 text-3xl font-black text-[#0d3d21]">
                    Les places de la 1ʳᵉ édition partent vite
                  </h2>
                  <p className="mt-4 text-lg text-[#4f5f51]">
                    Recevez le programme, les intervenants et les dernières infos de logistique
                ...
                <div>
                  ...
                  <form onSubmit={handleNewsletterSubmit} className="mt-4 flex gap-2">
                    <input
                      ...
                      className="h-11 min-w-0 flex-1 rounded-full border border-[#e3dccf] bg-[#fbf5eb] px-4 text-sm text-[#183b24] outline-none placeholder:text-[#8a988f] disabled:opacity-60"
                    />
                    <Button
                      type="submit"
                  ...
                  {newsletterStatus === "success" && (
                    <p className="mt-2 text-sm font-medium text-[#0b7a3c]">
                      Merci, vous êtes inscrit·e.
                    </p>
                  )}
                  {newsletterStatus === "error" && (
                    <p className="mt-2 text-sm font-medium text-[#e8722a]">
