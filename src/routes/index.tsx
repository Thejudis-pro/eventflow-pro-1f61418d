...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.fesaforum.com/" },
      { property: "og:image", content: `https://www.fesaforum.com${socialBanner}` },
  ...
  const eventJsonLd = useMemo(
    () => ({
      ...
      offers: TIERS.map((tier) => ({
        ...
        url: "https://www.fesaforum.com/inscription",
      })),
    }),
    [event],
  );
          ...
          <div className="grid gap-10 border-b border-[rgba(251,247,240,.14)] pb-10 sm:grid-cols-2 lg:grid-cols-[320px_repeat(3,minmax(0,1fr))_300px]">
            <div>
              ...
              <p className="mt-4 text-[13.5px] leading-[1.7] text-[rgba(251,247,240,.62)]">
                Forum de l'Entrepreneuriat et de la Souveraineté Alimentaire, organisé par la PAAF —
