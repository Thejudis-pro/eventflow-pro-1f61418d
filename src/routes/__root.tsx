...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FESA 2026 — Forum entrepreneuriat & souveraineté alimentaire" },
      {
        name: "description",
        content:
          "Plateforme d'inscription du FESA 2026, organisé par la PAAF à Dakar les 21 et 22 septembre 2026.",
      },
      { name: "author", content: "PAAF" },
      ...
      { name: "theme-color", content: "#0d3d21" },
    ],
    links: [
