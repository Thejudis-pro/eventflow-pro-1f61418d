...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://fesa2026.vercel.app/" },
      { property: "og:image", content: `https://fesa2026.vercel.app${socialBanner}` },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: `https://fesa2026.vercel.app${socialBanner}` },
    ],
    links: [{ rel: "canonical", href: "https://fesa2026.vercel.app/" }],
  }),
  component: Landing,
});
  ...
  const eventJsonLd = useMemo(
    () => ({
      ...
      offers: TIERS.map((tier) => ({
        ...
        url: "https://fesa2026.vercel.app/inscription",
      })),
    }),
    [event],
  );
