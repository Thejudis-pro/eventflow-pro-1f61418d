DROP FUNCTION IF EXISTS public.register_participant(uuid,uuid,uuid,text,text,text,text,text,text,text);
...
END;
$$;
GRANT EXECUTE ON FUNCTION public.register_participant(uuid,uuid,text,text,text,text,text,text,text,text) TO anon, authenticated;
